  ...
  object qryRelTot: TZReadOnlyQuery
    ...
    SQL.Strings = (
      '(SELECT  '
        ...
        #9'D.DS_MOTIVO as "Motivo",cast(COUNT(f.nro_conta) as char(10)) AS' +
        ' "Qtde",'#39'Fatura'#39' as "Produto"'
      '    '
      'FROM  '
      '    cea_CONTROLE_DEVOLUCOES F'
        ...
        'IVO'
      'WHERE'
      '    (F.DT_DEVOLUCAO BETWEEN :par1 and :par2)'
      'GROUP BY'
      #9'D.DS_MOTIVO)'
      'union'
      ''
      '(SELECT  '
        ...
        #9'D.DS_MOTIVO as "Motivo",cast(COUNT(f.cod_ar) as char(10)) AS "Q' +
        'tde", '#39'Cartao-AR'#39' as "Produto"'
      '    '
      'FROM  '
      ...
      '(SELECT  '
        ...
        #9'D.DS_MOTIVO as "Motivo",cast(COUNT(f.nro_cartao) as char(10)) A' +
        'S "Qtde",'#39'Catao-Fac'#39' as "Produto"'
      '    '
      'FROM  '
    ...
    object qryRelTotMotivo: TStringField
      FieldName = 'Motivo'
      ReadOnly = True
      Size = 40
    end
    object qryRelTotQtde: TStringField
      FieldName = 'Qtde'
      ReadOnly = True
      Size = 10
    end
    object qryRelTotProduto: TMemoField
      FieldName = 'Produto'
      ReadOnly = True
      BlobType = ftMemo
    end
