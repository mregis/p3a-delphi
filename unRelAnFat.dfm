object frmRelAnFAT: TfrmRelAnFAT
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Relat'#243'rio Anal'#237'tico Fatura'
  ClientHeight = 188
  ClientWidth = 389
  Color = clBtnFace
  ...
  object qryRelFAT: TZReadOnlyQuery
    ...
    SQL.Strings = (
      'select '
        ...
        #9'COUNT(A.nro_conta) AS QTD_REG, D.DS_MOTIVO,  A.CD_MOTIVO, F.FAM' +
        'ILIA'
      'from '
      #9'cea_controle_devolucoes A,'
      #9'cea_motivos_devolucoes D,'
      #9'cea_cadastro_familia F'
      ''
      'WHERE '
    ...
    object qryRelFATqtd_reg: TLargeintField
      FieldName = 'qtd_reg'
      ReadOnly = True
    end
    object qryRelFATds_motivo: TStringField
      FieldName = 'ds_motivo'
      Required = True
      Size = 40
    end
    object qryRelFATcd_motivo: TStringField
      FieldName = 'cd_motivo'
      Required = True
      Size = 2
    end
    object qryRelFATfamilia: TStringField
      FieldName = 'familia'
      Required = True
      Size = 60
    end
